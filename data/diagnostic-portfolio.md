# Diagnostic honnête du portfolio

Ce document synthétise l'évaluation du portfolio à partir de la grille officielle et de l'état actuel du site.

## Avis global

Le portfolio est déjà sérieux et au-dessus d'un simple site vitrine scolaire. Il coche beaucoup de critères importants :
...
- vérifier l'affichage du CV ;
- tester le formulaire de contact ;
- préparer une capture de secours en cas de problème de connexion.

## Risque à surveiller

Le terminal interactif, les effets visuels et les previews donnent de la personnalité au site. Ils sont intéressants, mais ils ne doivent pas prendre le dessus pendant l'oral.
...
Les effets doivent soutenir le propos, pas devenir le sujet principal.
